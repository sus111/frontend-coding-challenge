  ...
  <div class="grid-x grid-x-margin">
    <div class="cell small-12 medium-6 medium-offset-3">
      <div class="survey-questions__goals align-center">
        ...
        <check-button @handle-goal-click="handleGoalClick" v-for="(goal, key) in goals" :key="key" :text="goal.name" :value="goal.value" :selected="selectedGoals.includes(goal.value)" customEvent="handle-goal-click"></check-button>
